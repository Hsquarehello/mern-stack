...
const Pagination = ({ links, page }) => (
  <div className="flex items-center text-white justify-between border-t border-gray-200 bg-gray-900 px-4 py-3 sm:px-6">
            ...
            if (link.number == page) {
              ...
              return (
                <Link
                  ...
                  key={link.number}
                  href="#"
                  className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-200 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 hover:text-gray-950 focus:z-20 focus:outline-offset-0">
                  {link.number}
                </Link>
              );
            }
